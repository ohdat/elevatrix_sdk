...
var Elevatrix = function () {
    ...
    var getMintInfo = function (params, apiBaseUrl) { return __awaiter(_this, void 0, void 0, function () {
        var projectId, quantity, wallet, mintType, backupUrl, url, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    projectId = params.projectId, quantity = params.quantity, wallet = params.wallet, mintType = params.mintType;
                    backupUrl = 'https://creator.elevatrix.xyz/';
                    url = (apiBaseUrl || backupUrl) + "/v1/mint?quantity=".concat(quantity, "&project_id=").concat(projectId, "&wallet=").concat(wallet, "&mint_type=").concat(mintType);
     ...
     */
    var mint = function (params, apiBaseUrl) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getMintInfo(params, apiBaseUrl)];
                case 1:
                    res = _a.sent();
                    if (res.code != 200) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    amount = ethers.ethers.parseEther((Number(res.data.price) * res.data.quantity).toString());
                    ethersProvider = new ethers.ethers.BrowserProvider(provider);
                    return [4 /*yield*/, ethersProvider.getSigner()];
                case 4:
                    signer = _a.sent();
                    contractAddress = res.data.contract;
                    contract = new ethers.ethers.Contract(contractAddress, ContractABI, signer);
                    contractParams = {
                        ...
                        price: ethers.ethers.parseEther(res.data.price),
...
if(typeof window !== 'undefined') {
  window.elevatrix_sdk_Version = '0.0.2'
}
